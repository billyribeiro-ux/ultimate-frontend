---
module: Module 8 — SvelteKit Routing & Layouts
lesson: 8.10
title: instrumentation.server.ts — OpenTelemetry support
status: stub
---

# Lesson 8.10 — instrumentation.server.ts — OpenTelemetry support
